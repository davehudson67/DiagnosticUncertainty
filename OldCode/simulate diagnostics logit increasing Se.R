...
summaryinference<-array(0,dim=c(length(psensvec),(2*ntests+1)))
summaryinfsd<-array(0,dim=c(length(psensvec),(2*ntests+1)))
...
params <- c("pprevlogit", "psenslogit", "pspeclogit")
