...
aSD <- ggplot(plot_dataSD, aes(x = true_sens, y = inferred_sensSD)) +
...
bSD <- ggplot(plot_dataSD, aes(x = true_sens, y = inferred_specSD)) +
  geom_point(alpha = 0.2) +
  xlab("") +
  ylab("Standard deviation") +
...
# Plotting inferred specificity vs true sensitivity
cSD <- ggplot(plot_dataSD, aes(x = true_sens, y = inferred_prevSD)) +
  geom_point(alpha = 0.2) +
  xlab("") +
  ylab("Standard deviation") +
  #ggtitle("Inferred vs True Sensitivity Across Iterations") +
