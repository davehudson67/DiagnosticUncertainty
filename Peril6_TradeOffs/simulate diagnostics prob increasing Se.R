...
summaryprobinference<-array(0,dim=c(length(psensvec),(2*ntests+1)))
summaryprobinfsd<-array(0,dim=c(length(psensvec),(2*ntests+1)))
...
summaryprobinference[q,]<-runprobsummary$mean
summaryprobinfsd[q,]<-runprobsummary$sd
}
